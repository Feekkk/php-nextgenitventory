        ...
        <div class="import-card">
            <form class="import-form" method="POST" enctype="multipart/form-data">
                ...
                <div class="guidelines">
                    ...
                    <ul>
                        <li>Ensure headers match the template and remain lowercase.</li>
                        <li>Required columns: Asset ID, Equipment Type, Brand, Model, Serial Number, Location, Status.</li>
                        <li>IP, VLAN, firmware, and rack data are optional but recommended.</li>
                    ...
                    <table class="sample-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Catalyst 9300</td>
                                <td>SN4452331</td>
                                <td>Data Center Rack B2</td>
                                <td>available</td>
                            </tr>
                        </tbody>
                    </table>
                    <small style="color:#636e72;">Optional columns: ip_address, mac_address, management_vlan, firmware_version, rack_position, assigned_team, purchase_date, warranty_expiry, condition.</small>
                </div>
