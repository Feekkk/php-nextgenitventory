...
<div id="header-root">
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <ul>
            <li><a href="../technician/Dashboard.php"><i class="fa fa-gauge"></i> Dashboard</a></li>
            ...
            <li><a href="../technician/History.php"><i class="fa fa-clock-rotate-left"></i> History</a></li>
            <li><a href="../technician/UserManual.php"><i class="fa fa-book"></i> User Manual</a></li>
            <li><a href="../technician/Profile.php"><i class="fa fa-user"></i> Profile</a></li>
